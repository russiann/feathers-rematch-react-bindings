(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react-redux"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define(["react-redux", "react"], factory);
	else if(typeof exports === 'object')
		exports["feathers-rematch-react-bidings"] = factory(require("react-redux"), require("react"));
	else
		root["feathers-rematch-react-bidings"] = factory(root["React-redux"], root["React"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_59__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.Service = exports.Snapshot = undefined;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getData = function getData(rootState, _ref) {
	  var name = _ref.name,
	  ...
	  var method = get ? 'get' : 'find';
	  var defaultResult = method === 'find' ? [] : null;

	  if (namespace) {
	    return (0, _get3.default)(rootState, name + '.namespaces.' + namespace + '.' + method + '.result', defaultResult);
	  }

	  return (0, _get3.default)(rootState, name + '.' + method + '.result', defaultResult);
	};

	var mapStateToProps = function mapStateToProps(rootState, props) {
	  return {
	    rootState: rootState,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Service = function (_Component) {
	  ...
	  _createClass(Service, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      if (get) {
	        dispatch[name].get({ id: get, params: params, namespace: namespace });
	      } else {
	        console.log('find', find);
	        dispatch[name].find({ params: find, namespace: namespace });
	      }
	    }
	  }, {
	    key: 'render',
	...
	exports.default = (0, _container2.default)(Service);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _sift3 = __webpack_require__(12);

	var _sift4 = _interopRequireDefault(_sift3);
	...
	var getData = function getData(rootState, _ref) {
	  ...
	  var data = publication ? (0, _get2.default)(rootState, name + '.publications.' + publication, []) : (0, _get2.default)(rootState, name + '.store', []);

	  if (findOne) {
	    var _sift = (0, _sift4.default)(findOne, data),
	        _sift2 = _slicedToArray(_sift, 1),
	        record = _sift2[0];
	  ...
	  if (find) {
	    return (0, _sift4.default)(find, data);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _container2.default)(Snapshot);
